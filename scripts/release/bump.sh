...
# PACKAGE_ROOT mirrors the repo-root layout (VERSION + packages/diene_dart_lib/
...
yq -i ".version = \"${version}\"" "${root_dir}/packages/diene_dart_lib/pubspec.yaml"

echo "✅ VERSION and packages/diene_dart_lib/pubspec.yaml stamped to ${version}"
